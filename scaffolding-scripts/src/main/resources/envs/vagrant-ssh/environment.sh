...
# Container IPs
fabric1_static="10.20.1.11"

amq_hosts="10.20.1.12"
app_hosts="10.20.1.13"
...
export FABRIC_CREATE_CMD="fabric:create --force --clean --resolver manualip --manual-ip=10.20.1.11 --profile default --wait-for-provisioning"
